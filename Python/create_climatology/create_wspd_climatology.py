...
pl = None
subsampletime = 1
starttime = '1999-01-07'
endtime = '2015-12-30'


outclimDir = outPath+ft+'/'+mo+'/'+'wspd'+'/'+str(pl)+'/daily/clim/'
if not os.path.isdir(outclimDir):
    os.makedirs(outclimDir)
climfname = 'day_clim.nc'
sclimfname = 'smooth_day_clim.nc'

# Find out how many ensembles associated with the GEFSel:
...
ds = ds.sel(Y=slice(90, 0), X=slice(180, 360)).squeeze()
# Obtain data zgialbe
uas = ds[va]
